...
#use a single try/except statement with multiple functions

#Python, expcetiosn are propagated through functions
...
#
print('Hi, I will collect some info abuot your bday!')
user_info = []
